...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Venky Adventure</a>
	    ...
	    <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="../food.php" class="nav-link">Restaurant</a></li>
	          <li class="nav-item"><a href="../halls.php" class="nav-link">Halls</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bckg.jpg');">
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/korangi.jpg);">
        			<div class="text text-center">
        				<h3>Korangi Mada Forests </h3>
        			</div>
        		</a>
        	</div>
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/konasema.jpg);">
        			<div class="text text-center">
        				<h3>Kona Sema </h3>
        			</div>
        		</a>
          ...
          <div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/bhuva.jpg);">
        			<div class="text text-center">
        				<h3>Temple </h3>
        			</div>
        		</a>
          ...
          <div class="col-md-4 ftco-animate">
        	...
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/antrvedi.jpg);">
        			<div class="text text-center">
        				<h3>antervadi</h3>
        			</div>
        		</a>
    	...
    	<div class="one-half img" style="background-image: url(images/guytrvel.jpg);"></div>
    	<div class="one-half ftco-animate">
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">The Best Travel Service By Venky </h2>
        </div>
        <div>
		        ...
		        <  <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                ...
		                <span><a href="https://testhotel12.herokuapp.com/index.php">Venky Resturant</span></a>
		              </div>
		            </div>
		          </div>
